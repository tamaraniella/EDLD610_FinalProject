...
Again, for this visualization I think that the plot divided by region is a lot more clear and easier to look at. I would go for the one divided by country only if you are trying to transmit something about a country in particular .. and in that case I woud advice higlighting the bar that represents that country! 

I thin it's useful to have the nambers in each bar since it helps to see the differences, since they are so small. Could you increase the size of the numbers though? (I increased it by 1 point and looks a bit better I think)
